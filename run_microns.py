...
if __name__ == "__main__":
    for [ww,cc,ss] in [["noise", "count", "all"]]:
        for D_ in [2]:
            R_max_lst = ["1"]
            # R_max_lst = ["1"]
            D = D_
            ...
            for R_max in R_max_lst:
                raw_data = False 
                # all_run(R_max, D, raw_data, ww, cc, ss, scan_specific, downsample_from_connectome, pendindex)
                microns_across_scans(R_max, D, 5, pendindex, scan_specific, perturb)
